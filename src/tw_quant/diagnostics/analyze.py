...
def _write_diagnostics_report(
    ...
    content = "\n".join(
        [
            ...
            "- Research Narrative: `original_monthly` is the pure-alpha benchmark, while `risk_controlled_3m_half_exposure_exp60` remains the current practical candidate.",
            "- Phase G Practical Checks: delay and tighter max-weight variants are only small execution-realism checks around the same practical line.",
            "",
            "## Headline Context",
            "",
